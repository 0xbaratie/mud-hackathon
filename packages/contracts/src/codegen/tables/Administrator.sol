...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("Administrator")));
bytes32 constant AdministratorTableId = _tableId;
...
library Administrator {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("Administrator", _fieldNames);
  }
